...
client.on('group_join', async (notification) => {
    ...
    client.sendMessage(number, `Hai perkenalkan aku CMT Bot, selamat datang di group ini`);
...
https://chat.whatsapp.com/G7sVrKrcnxiAcllZIZXlas

			  ️*List Menu*
			
★️ !admin = Menu Ini Khusus Admin Grup🏅
★️ !menu1 = Fun Menu 🌞
...
contoh : !yt https://youtu.be/HNO0tTVjl4I

*!ytmp3 url* : Mendownload mp3 dari youtube
contoh : !ytmp3 https://youtu.be/ZFZFlPR8DEk
